  ...
  return (
    <div className="min-h-dvh w-full bg-[#0b0c10] text-[var(--text-primary)]">
      <div className="mx-auto flex min-h-dvh w-full max-w-[480px] items-stretch justify-center md:max-w-none md:items-center md:px-6 md:py-8">
        <div
          className="relative flex h-dvh w-full flex-col overflow-hidden bg-[var(--canvas)] md:h-[var(--phone-h)] md:w-[var(--phone-w)] md:rounded-[44px] md:border md:border-white/10 md:shadow-[0_30px_80px_rgba(0,0,0,0.55)]"
          data-phone-shell
        >
          <div className="pointer-events-none absolute inset-x-0 top-0 z-30 hidden h-[var(--safe-top)] md:block">
            <div className="mx-auto mt-3 h-[28px] w-[120px] rounded-full bg-black/80" />
          ...
          <div className="relative flex min-h-0 flex-1 flex-col pt-[env(safe-area-inset-top)] md:pt-[var(--safe-top)]">
            {children}
          </div>
